...
SynonymWord.create!(word_id: 1, synonym_id:1, user_rating: nil)
SynonymWord.create!(word_id: 2, synonym_id:2, user_rating: nil)
SynonymWord.create!(word_id: 3, synonym_id:3, user_rating: nil)
SynonymWord.create!(word_id: 4, synonym_id:4, user_rating: nil)
